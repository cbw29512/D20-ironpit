...
_HERO_ONLY_PROGRESSION_FIELDS = {
    ...
    "great_weapon_fighting", "indomitable_reroll", "indomitable_bonus", "failed_save_reroll_source_id",
    "failed_save_reroll_resource_id", "failed_save_reroll_bonus", "tactical_master_sap_weapon_ids",
    "sneak_attack_d6", "uncanny_dodge", "evasion",
    "martial_arts_bonus_attack", "martial_arts_die_size", "flurry_of_blows", "deflect_missiles",
    "deferred_save_effect", "timed_self_buff", "opening_targeting_ward",
