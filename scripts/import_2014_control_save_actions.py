...
def _sleep_breath(name: str, text: str, area: dict, save: tuple[str, int], resource_id: str) -> dict | None:
    ...
    ability, dc = save
    return {"id": "sleep-breath", "name": name, "save_ability": ability, "dc": dc, "range_ft": _range(area), "area": area,
...
def _paralyzing_breath(name: str, text: str, area: dict, save: tuple[str, int], resource_id: str) -> dict | None:
    ...
    ability, dc = save
    return {"id": "paralyzing-breath", "name": name, "save_ability": ability, "dc": dc, "range_ft": _range(area), "area": area,
...
def _slowing_effect(name: str, text: str, area: dict, save: tuple[str, int], resource_id: str) -> dict | None:
    ...
    return {"id": action_id, "name": name, "save_ability": ability, "dc": dc, "range_ft": _range(area), "area": area,
...
def _weakening_breath(name: str, text: str, area: dict, save: tuple[str, int], resource_id: str) -> dict | None:
    ...
    if duration is None or not all(re.search(pattern, text, re.I) for pattern in required): return None
    ability, dc = save
    return {"id": "weakening-breath", "name": name, "save_ability": ability, "dc": dc, "range_ft": _range(area), "area": area,
...
def _petrifying_breath(name: str, text: str, area: dict, save: tuple[str, int], resource_id: str) -> dict | None:
    ...
    ability, dc = save
    return {"id": "petrifying-breath", "name": name, "save_ability": ability, "dc": dc, "range_ft": _range(area), "area": area,
...
def _repulsion(name: str, text: str, area: dict, save: tuple[str, int], resource_id: str) -> dict | None:
    ...
    ability, dc = save
    return {"id": "repulsion-breath", "name": name, "save_ability": ability, "dc": dc, "range_ft": _range(area), "area": area,
