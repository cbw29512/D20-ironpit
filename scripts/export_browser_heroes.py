...
def _template(key: tuple[str, int, str], template: CombatantTemplate) -> dict[str, Any]:
    ...
    row: dict[str, Any] = {
        ...
        "brutal_critical_dice": progression.brutal_critical_dice, "fast_movement_bonus_ft": progression.fast_movement_bonus_ft,
        ...
        "cunning_action": progression.cunning_action, "uncanny_dodge": progression.uncanny_dodge,
        "evasion": progression.evasion, "martial_arts_bonus_attack": progression.martial_arts_bonus_attack,
