...
def _modifier_effect(effect: Any) -> dict[str, Any]:
    ...
    if effect.effect_tag: row["effectTag"] = effect.effect_tag
...
def _template(key: tuple[str, int, str], template: CombatantTemplate) -> dict[str, Any]:
    ...
    row: dict[str, Any] = {
        ...
        "spell_damage_bonus_grants": [item.model_dump() for item in progression.spell_damage_bonus_grants],
        "free_spell_cast_grants": [item.model_dump() for item in progression.free_spell_cast_grants],
        ...
        "passive_modifier_grants": [
            ...
            for grant in progression.passive_modifier_grants
        ],
