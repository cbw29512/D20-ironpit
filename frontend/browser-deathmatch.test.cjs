...
for (const file of [
  ...
  "browser-frenzy-2014.js", "browser-2014-monk.js", "browser-ability-hook-installation.js", "browser-save-action-policy.js", "browser-turn.js", "browser-initiative.js", "browser-engine.js",
]) load(file);
