...
for (const file of [
  ...
  "browser-spell-attack-policy.js", "browser-spell-attack.js", "browser-spell-offense.js", "browser-ability-hooks.js", "browser-save-action-policy.js", "browser-turn.js",
]) load(file);
