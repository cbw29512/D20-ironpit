...
for (const file of [
  ...
  "browser-attack-outcome.js", "browser-attack.js", "browser-saves.js", "browser-charge.js", "browser-formation.js", "browser-multiattack.js", "browser-ability-hooks.js", "browser-turn.js",
]) load(file);
