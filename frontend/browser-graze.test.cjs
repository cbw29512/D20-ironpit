...
for (const htmlPath of [path.join(__dirname, "index.html"), path.join(__dirname, "..", "index.html")]) {
  ...
  assert.ok(html.indexOf("browser-graze.js") < html.indexOf("browser-attack-roll-context.js", "browser-attack.js"));
}
for (const file of [
  ...
  "browser-graze.js", "browser-ability-hooks.js", "browser-attack-outcome.js", "browser-attack-roll-context.js", "browser-attack.js",
]) load(file);
