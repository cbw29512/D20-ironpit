(() => {
  ...
  function resolveObscure(attacker, defender, turnKey) {
    ...
    if (!save.succeeded) {
      ...
      applied = Boolean(T()?.apply(defender, "blinded", sourceId, {
        sourceEffectId: OBSCURE, expiresAtStartOfSourceTurn: false,
        expiryTiming: "target_turn_end", useDefaultPoisonRecovery: false,
      }));
    }
  ...
  window.IRON_PIT_BROWSER_SNEAK_ATTACK = { allyAvailable, bonusDamage, obscureDieCost, resolveObscure, resolveTrip, tripDieCost };
})();
