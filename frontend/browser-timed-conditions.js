(() => {
  ...
  function apply(state, effectId, sourceId, options = {}) {
    ...
    state.timed_effects.push({
      ...
      repeat_save_failure_continues: options.repeatSaveFailureContinues !== false,
      repeat_save_failure_duration_rounds: options.repeatSaveFailureDurationRounds ?? null,
      repeat_save_failure_ends_on_damage: Boolean(options.repeatSaveFailureEndsOnDamage),
      repeat_save_failure_allowed_removal_action_ids: [...(options.repeatSaveFailureAllowedRemovalActionIds || [])],
