...
for (const htmlPath of [path.join(__dirname, "index.html"), path.join(__dirname, "..", "index.html")]) {
  ...
  assert.match(html, /<script\b[^>]*\bsrc="browser-barbarian2\.js"[^>]*><\/script>/, `${htmlPath} must load Barbarian 2 runtime rules`);
}
for (const file of [
  ...
  "browser-condition-removal.js", "browser-support.js", "browser-ability-hooks.js", "browser-save-action-policy.js", "browser-turn.js", "browser-formation.js", "browser-initiative.js", "browser-engine.js",
]) load(file);
