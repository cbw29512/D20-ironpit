...
for (const file of [
  ...
  "browser-condition-removal.js", "browser-support.js", "browser-progression-recovery.js", "browser-turn.js", "browser-formation.js", "browser-initiative.js", "browser-engine.js",
]) load(file);
