...
(() => {
  ...
  window.IRON_PIT_BROWSER_SPELL_TARGET_RULES = {"blight":{"excludedCreatureTypes":["undead","construct"],"maximizeDamageCreatureTypes":["plant"],"saveDisadvantageCreatureTypes":["plant"]}};
})();
