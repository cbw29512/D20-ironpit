...
assert.equal(heroes2014.length, 93, "2014 browser hero roster must contain Fighter 1-20, Barbarian 1-20, Rogue 1-20, Monk 1-20, and Paladin 1-13");
...
assert.equal(paladins2014.length, 13);
