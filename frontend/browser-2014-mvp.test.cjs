...
assert.equal(Object.keys(window.IRON_PIT_BROWSER_MONSTERS_2014).length, 127);
...
assert.equal(heroes2014.length, 70, "2014 browser hero roster must contain Fighter and Barbarian 1-20, and Rogue, Monk, Paladin 1-10");
...
runCertifiedFight("rokhan-stonefury-2014-l20", 20);
