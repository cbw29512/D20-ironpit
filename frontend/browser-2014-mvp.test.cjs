...
assert.equal(Object.keys(window.IRON_PIT_BROWSER_MONSTERS_2014).length, 128);
...
assert.equal(heroes2014.length, 80, "2014 browser hero roster must contain Fighter 1-20, Barbarian 1-20, Rogue 1-19, Monk 1-10, and Paladin 1-11");
assert.equal(fighters2014.length, 20);
assert.equal(barbarians2014.length, 20);
assert.equal(rogues2014.length, 19);
