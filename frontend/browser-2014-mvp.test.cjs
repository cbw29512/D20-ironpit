...
assert.equal(heroes2014.length, 30, "2014 browser hero roster must contain Fighter 1-20 and Barbarian 1-10");
...
for (const id of [
  ...
  "2014-tiger", "2014-triceratops", "2014-warhorse", "2014-goat", "2014-giant-goat", "2014-mule",
...
assert.throws(
  () => window.IRON_PIT_BROWSER_ENGINE.runEncounter({
    ruleset: "2014", hero_ids: ["rokhan-stonefury-2014-l5"], monster_ids: ["srd-wolf"],
  }),
  /Unknown certified monster for 2014/,
);

console.log("Certified 2014 Fighter and Berserker browser fights passed.");
