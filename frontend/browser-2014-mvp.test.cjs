...
assert.equal(heroes2014.length, 89, "2014 browser hero roster must contain Fighter 1-20, Barbarian 1-20, Rogue 1-20, Monk 1-17, and Paladin 1-12");
assert.equal(fighters2014.length, 20);
assert.equal(barbarians2014.length, 20);
assert.equal(rogues2014.length, 20);
assert.equal(monks2014.length, 17);
