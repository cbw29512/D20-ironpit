(() => {
  ...
  const G = () => window.IRON_PIT_BROWSER_GRAPPLE, T = () => window.IRON_PIT_BROWSER_TIMED, Z = () => window.IRON_PIT_BROWSER_ZERO_HP, P = () => window.IRON_PIT_BROWSER_PERSISTENT_EFFECTS;
