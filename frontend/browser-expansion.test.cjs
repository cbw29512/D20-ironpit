...
for (const file of [
  ...
  "browser-rolls.js", "browser-zero-hp.js", "browser-ability-hooks.js", "browser-attack-outcome.js", "browser-attack-roll-context.js", "browser-attack.js", "browser-formation.js", "browser-multiattack.js",
]) load(file);
