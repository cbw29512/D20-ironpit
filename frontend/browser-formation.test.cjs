...
const ranged = { kind: "character", primary_attack_id: "bow", attacks: [{ id: "bow", kind: "ranged", long: 80 }] };
...
const archerTemplate = template("Archer", "bow", [bow, sword]);
...
console.log("Simple true-range/close-to-melee browser policy regressions passed.");
