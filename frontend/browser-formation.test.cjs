...
for (const file of [
  ...
  "browser-grapple.js", "browser-state.js", "browser-formation.js", "browser-standard-attack-action.js", "browser-ability-hooks.js", "browser-save-action-policy.js", "browser-turn.js",
]) load(file);
