...
for (const file of [
  ...
  "browser-action-economy.js", "browser-state.js", "browser-zero-hp.js", "browser-ability-hooks.js", "browser-attack-outcome.js", "browser-attack-roll-context.js", "browser-attack.js",
]) load(file);
