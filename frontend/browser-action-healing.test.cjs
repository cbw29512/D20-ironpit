...
for (const file of ["browser-heroes.js", "browser-condition-immunity.js", "browser-condition-rules.js", "browser-state.js", "browser-action-economy.js", "browser-healing-policy.js", "browser-healing.js", "browser-group-healing.js"]) load(file);
