...
for (const name of ["browser-main-action-profiles.js", "browser-main-action-selection.js", "browser-damage-reactions.js", "browser-main-action-providers.js", "browser-spell-offense.js"]) vm.runInThisContext(fs.readFileSync(path.join(__dirname, name), "utf8"), { filename: name });
