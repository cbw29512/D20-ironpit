...
assert.ok(rogue2 && rogue5 && rogue7 && rogue10 && rogue11 && rogue12 && rogue13 && rogue14 && rogue15 && rogue16 && rogue17 && rogue18 && rogue19);
...
console.log("2014 Thief Rogue browser mechanics preserve Cunning Action, Uncanny Dodge, Evasion, Slippery Mind, approved Constitution ASIs, level-19 progression, and edition isolation.");
