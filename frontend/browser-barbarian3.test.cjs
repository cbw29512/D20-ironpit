...
for (const htmlPath of [path.join(__dirname, "index.html"), path.join(__dirname, "..", "index.html")]) {
  ...
  assert.match(html, /<script\b[^>]*\bsrc="browser-barbarian3\.js"[^>]*><\/script>/, `${htmlPath} must load Barbarian 3 runtime rules`);
}
for (const file of [
  ...
  "browser-rage.js", "browser-barbarian3.js", "browser-rolls.js", "browser-zero-hp.js", "browser-ability-hooks.js", "browser-attack-outcome.js", "browser-attack-roll-context.js", "browser-attack.js",
