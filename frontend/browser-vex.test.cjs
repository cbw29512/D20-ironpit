...
for (const htmlPath of [path.join(__dirname, "index.html"), path.join(__dirname, "..", "index.html")]) {
  ...
  assert.ok(html.indexOf("browser-vex.js") < html.indexOf("browser-attack-roll-context.js", "browser-attack.js"));
}
for (const file of [
  ...
  "browser-vex.js", "browser-ability-hooks.js", "browser-attack-outcome.js", "browser-attack.js",
]) load(file);
