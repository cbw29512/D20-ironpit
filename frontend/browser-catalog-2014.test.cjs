...
(async () => {
  ...
  console.log("2014 catalog exposes Fighter 1-20, Berserker 1-10, and Thief 1-10 against the certified monster roster.");
})().catch((error) => {
  console.error(error);
  process.exitCode = 1;
});
