...
(async () => {
  ...
  console.log("2014 catalog exposes Fighter 1-20, Berserker 1-10, Thief 1-10, and Open Hand Monk 1-10.");
})().catch((error) => {
  console.error(error);
  process.exitCode = 1;
});