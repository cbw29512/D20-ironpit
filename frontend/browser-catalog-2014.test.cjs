...
(async () => {
  ...
  console.log("2014 catalog exposes Fighter 1-20, Berserker 1-20, Thief 1-11, and Open Hand Monk, Devotion Paladin 1-10.");
})().catch((error) => {
  console.error(error);
  process.exitCode = 1;
});