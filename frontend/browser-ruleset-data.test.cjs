...
assert.ok(heroes2014.length >= 120, "2014 browser heroes must preserve all completed 1-20 progressions");
levels(fighters2014, 20); levels(barbarians2014, 20); levels(rogues2014, 20); levels(monks2014, 20); levels(paladins2014, 20); levels(clerics2014, 20);
if (bards2014.length) levels(bards2014, bards2014.length);
...
const paladin16 = paladins2014.find((hero) => hero.level === 16);
assert.ok(paladin16);
assert.equal(paladin16.ability_scores.charisma, 19);
...
const paladin19 = paladins2014.find((hero) => hero.level === 19);
assert.ok(paladin19);
assert.equal(paladin19.ability_scores.charisma, 20);
assert.equal(paladin19.ability_scores.dexterity, 12);
assert.equal(paladin19.aura_of_protection_2014_bonus, 5);
assert.equal(paladin19.resources["spell-slot-5"], 2);
assert.deepEqual(
