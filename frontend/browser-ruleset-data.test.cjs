...
assert.equal(heroes2014.length, 83, "2014 browser heroes must contain Fighter 1-20, Barbarian 1-20, Rogue 1-20, Monk 1-11, and Paladin 1-12");
levels(fighters2014, 20); levels(barbarians2014, 20); levels(rogues2014, 20); levels(monks2014, 11); levels(paladins2014, 12);
...
const rogue11 = rogues2014.find((hero) => hero.level === 11);
const rogue12 = rogues2014.find((hero) => hero.level === 12);
const rogue13 = rogues2014.find((hero) => hero.level === 13);
const rogue14 = rogues2014.find((hero) => hero.level === 14);
const rogue15 = rogues2014.find((hero) => hero.level === 15);
const rogue16 = rogues2014.find((hero) => hero.level === 16);
