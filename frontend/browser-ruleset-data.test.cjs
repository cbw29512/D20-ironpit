...
assert.equal(monsters2014.length, 32, "2014 browser roster must contain exactly 32 basic monsters");
for (const id of ["2014-bandit", "2014-brown-bear", "2014-goblin", "2014-skeleton", "2014-fire-giant", "2014-owlbear"]) {
