...
assert.equal(heroes2014.length, 74, "2014 browser heroes must contain Fighter 1-20, Barbarian 1-20, Rogue 1-13, Monk 1-10, and Paladin 1-11");
levels(fighters2014, 20); levels(barbarians2014, 20); levels(rogues2014, 13); levels(monks2014, 10); levels(paladins2014, 11);
