...
assert.equal(heroes2014.length, 85, "2014 browser heroes must contain Fighter 1-20, Barbarian 1-20, Rogue 1-20, Monk 1-14, and Paladin 1-11");
levels(fighters2014, 20); levels(barbarians2014, 20); levels(rogues2014, 20); levels(monks2014, 14); levels(paladins2014, 11);
