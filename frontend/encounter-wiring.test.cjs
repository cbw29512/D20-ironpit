...
assert.match(html, /browser-attack-outcome\.js/); assert.match(html, /browser-attack-outcome-hook-installation\.js/); assert.match(html, /browser-damage-reactions\.js/);
...
assert.ok(html.indexOf("browser-attack.js") < html.indexOf("browser-damage-reactions.js"));
assert.ok(html.indexOf("browser-damage-reactions.js") < html.indexOf("browser-light-attack.js"));
