...
assert.equal(Object.keys(generated).length, 72, "Generated runtime must expose only currently RAW-certified monsters");
for (const id of ["srd-jackal", "srd-archelon", "srd-ankylosaurus", "srd-giant-eagle", "srd-giant-elk"]) {
