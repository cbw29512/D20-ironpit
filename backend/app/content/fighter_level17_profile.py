...
def build_karnok_stoneward_level17_profile() -> CharacterBuildProfile:
    try:
        ...
        action_surge = FeatureAudit(
            ...
            source_reference="D&D Beyond Basic Rules 2024: Fighter Level 17 — Action Surge",
            category="class",
            combat_relevant=True,
            automated=True,
            notes=(
                "Level 17 raises Action Surge to two uses. Iron Pit reuses the existing "
                "universal resource and Action Surge execution path."
            ),
        )
        data.update(
