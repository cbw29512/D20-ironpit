...
def _attack(
    ...
    *,
    reach: int = 5,
    prone_max_size: CreatureSize | None = None,
    on_hit: list[OnHitDamage] | None = None,
) -> WeaponAttack:
    return WeaponAttack(
        id=attack_id,
        weapon=Weapon(
...
def build_archelon() -> CombatantTemplate:
    ...
    return CombatantTemplate(
        ...
        visual=build_monster_visual("shell", "bite", "archelon"),
        source="SRD 5.2.1 Archelon p. 345",
    )


def build_ankylosaurus() -> CombatantTemplate:
    tail = _attack(
        "ankylosaurus-tail", "Tail", 6, 1, 10, 4, DamageType.BLUDGEONING,
    ...
    return CombatantTemplate(
        ...
        visual=build_monster_visual("natural", "tail", "ankylosaurus"),
        source="SRD 5.2.1 Ankylosaurus p. 344",
    )
...
def build_giant_eagle() -> CombatantTemplate:
    ...
    return CombatantTemplate(
        ...
        visual=build_monster_visual("feathers", "talons", "giant-eagle"),
        source="SRD 5.2.1 Giant Eagle p. 351",
    )
...
def build_giant_elk() -> CombatantTemplate:
    ...
    return CombatantTemplate(
        ...
        damage_resistances=[DamageType.NECROTIC, DamageType.RADIANT],
        visual=build_monster_visual("fur", "antlers", "giant-elk"),
        source="SRD 5.2.1 Giant Elk p. 351",
    )
