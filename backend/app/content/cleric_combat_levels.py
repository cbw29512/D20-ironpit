...
CLERIC_COMBAT_LEVELS: dict[int, ClericCombatLevel] = {
    ...
    3: _r(3, 2, 18, 17, 14, 2, 1, _slots(4, 2), add=("disciple-of-life", "preserve-life"), source="D&D Beyond Basic Rules 2024: Cleric 3 Life Domain"),
    ...
    6: _r(6, 3, 33, 19, 14, 3, 1, _slots(4, 3, 3), add=("blessed-healer",), source="D&D Beyond Basic Rules 2024: Cleric 6 Life Domain Blessed Healer"),
    7: _r(7, 3, 38, 19, 14, 3, 2, _slots(4, 3, 3, 1), add=("potent-spellcasting", "cleric-combat-spells-4"), source="D&D Beyond Basic Rules 2024: Cleric 7 Blessed Strikes and level 4 spells"),
    ...
    14: _r(14, 5, 73, 20, 17, 3, 3, _slots(4, 3, 3, 3, 2, 1, 1), add=("improved-potent-spellcasting",), remove=("potent-spellcasting",), source="D&D Beyond Basic Rules 2024: Cleric 14 Improved Blessed Strikes"),
    ...
    17: _r(17, 6, 88, 20, 19, 3, 3, _slots(4, 3, 3, 3, 2, 1, 1, 1, 1), add=("supreme-healing", "cleric-combat-spells-9"), source="D&D Beyond Basic Rules 2024: Cleric 17 Life Domain Supreme Healing and level 9 spells"),
