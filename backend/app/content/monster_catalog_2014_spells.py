...
SCOPED_OUT_NON_DAMAGE_SPELLS_2014 = frozenset({
    ...
    "detect-magic", "detect-thoughts", "disguise-self", "dispel-evil-and-good", "dispel-magic",
    "divination", "dominate-monster", "dominate-person", "dream", "druidcraft", "entangle",
    "fly", "freedom-of-movement", "gaseous-form", "geas", "globe-of-invulnerability",
    "greater-invisibility", "greater-restoration", "heroes-feast", "hold-person", "identify",
    "invisibility", "legend-lore", "lesser-restoration", "light", "locate-object", "longstrider",
    "mage-armor", "mage-hand", "major-image", "mending", "mind-blank", "minor-illusion",
    "mirror-image", "misty-step", "nondetection", "pass-without-trace", "plane-shift",
    "polymorph", "power-word-stun", "prestidigitation", "raise-dead", "remove-curse",
    "resurrection", "sanctuary", "scrying", "shield", "shield-of-faith", "shillelagh",
    "silence", "sleep", "speak-with-animals", "spare-the-dying", "stoneskin", "suggestion",
    "thaumaturgy", "time-stop", "tongues", "teleport", "true-seeing", "wall-of-force",
    "water-breathing", "zone-of-truth",
})
