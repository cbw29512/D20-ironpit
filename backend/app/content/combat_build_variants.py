...
_VARIANTS = (
    ...
    _build("rogue", "duelist", "finesse-duelist", required_subclass_id="arcane-trickster"),
    _build("rogue", "dual-wield", "dual-wield-finesse", required_subclass_id="thief"),
    _build("rogue", "ranged", "crossbow-bow-sniper", required_subclass_id="assassin"),
    _build("wizard", "fire-damage", "fire-blaster", required_subclass_id="evoker"),
    _build("wizard", "frost-control", "cold-control", required_subclass_id="illusionist"),
    _build("wizard", "mixed-arcane", "balanced-arcane", required_subclass_id="abjurer"),
    _build("sorcerer", "fire-damage", "fire-blaster", required_subclass_id="draconic-sorcery"),
    _build("sorcerer", "frost-control", "cold-control", required_subclass_id="aberrant-sorcery"),
    _build("sorcerer", "mixed-arcane", "balanced-arcane", required_subclass_id="clockwork-sorcery"),
    _build("warlock", "blaster", "eldritch-blaster", required_subclass_id="fiend-patron"),
    _build("warlock", "controller", "control-caster", required_subclass_id="great-old-one-patron"),
    _build("warlock", "blade-hybrid", "weapon-caster-hybrid", required_subclass_id="celestial-patron"),
