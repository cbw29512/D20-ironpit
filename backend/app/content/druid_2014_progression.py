...
DRUID_2014_LEVELS: dict[int, Druid2014Level] = {
    ...
    2: Druid2014Level(2, 2, 2, _slots(3), 2, "1/4", False, False, False, ("wild-shape", "druid-circle")),
    3: Druid2014Level(3, 2, 2, _slots(4, 2), 2, "1/4", False, False, False),
    4: Druid2014Level(4, 2, 3, _slots(4, 3), 2, "1/2", True, False, False, ("ability-score-improvement", "wild-shape-improvement")),
    5: Druid2014Level(5, 3, 3, _slots(4, 3, 2), 2, "1/2", True, False, False),
    6: Druid2014Level(6, 3, 3, _slots(4, 3, 3), 2, "1/2", True, False, False),
    7: Druid2014Level(7, 3, 3, _slots(4, 3, 3, 1), 2, "1/2", True, False, False),
    8: Druid2014Level(8, 3, 3, _slots(4, 3, 3, 2), 2, "1", True, True, False, ("ability-score-improvement", "wild-shape-improvement")),
    9: Druid2014Level(9, 4, 3, _slots(4, 3, 3, 3, 1), 2, "1", True, True, False),
    10: Druid2014Level(10, 4, 4, _slots(4, 3, 3, 3, 2), 2, "1", True, True, False),
    ...
    14: Druid2014Level(14, 5, 4, _slots(4, 3, 3, 3, 2, 1, 1), 2, "1", True, True, False),
