...
from app.content.monsters_recharge_save import build_recharge_save_monsters
...
def build_legacy_monster_templates(*, include_capability_migrated: bool = True) -> list[CombatantTemplate]:
    ...
    monsters = [
        ...
        *build_zero_engine_monsters(), *build_target_not_full_hp_monsters(), *build_recharge_save_monsters(),
        *build_recharge_wyrmlings(), *build_recharge_young_dragons(), build_worg(), *build_swarm_candidates(), *build_parry_monsters(),
    ]
