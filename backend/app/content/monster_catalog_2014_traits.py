...
MODELED_TRAITS = {
    ...
    "Gnome Cunning": CombatTrait.GNOME_CUNNING,
...
DATA_BOUND_TRAITS = frozenset({
    "Angelic Weapons", "Aversion of Fire", "Barbed Hide", "Berserk", "Blood Frenzy", "Brute", "Corrosive Form", "Echolocation", "Fear of Fire",
