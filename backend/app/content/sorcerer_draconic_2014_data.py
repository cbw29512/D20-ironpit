...
ASI_CHOICES: tuple[tuple[int, str, int], ...] = (
    (4, "charisma", 2), (8, "charisma", 2),
    (12, "dexterity", 2), (16, "dexterity", 2),
    (19, "dexterity", 1), (19, "constitution", 1),
)
...
def ability_scores(level: int) -> AbilityScores:
    try:
        if level not in range(1, 21):
            raise ValueError("2014 Draconic Sorcerer level must be between 1 and 20.")
        ...
        logger.exception("Failed to resolve Nyra's 2014 ability scores at level %s.", level)
        raise
