...
FIGHTER_COMBAT_BUILD_CHOICES: dict[str, CombatBuildChoiceOverlay] = {
    ...
    "archer": CombatBuildChoiceOverlay(
        ...
        arena_ignored=("longbow-slow-mastery",),
        notes="Ranged-first Fighter; Longbow Slow is explicitly ignored when it cannot change an Iron Pit outcome.",
    ),
