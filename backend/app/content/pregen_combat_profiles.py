...
def build_pregen_combat_profiles() -> dict[str, PregenCombatProfile]:
    from app.content.rogue_combat_fingerprint import (
        ...
        build_mara_quickstep_level13_combat_profile, build_mara_quickstep_level14_combat_profile, build_mara_quickstep_level15_combat_profile, build_mara_quickstep_level16_combat_profile,
    )
    profiles = [
