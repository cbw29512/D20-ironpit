...
def build_rules_coverage() -> RulesCoverageReport:
    try:
        entries = [
            ...
            RuleCoverageEntry(id="disengage", name="Disengage", status=P, notes="Turn state and movement policy are implemented; Opportunity Attacks are not yet available to exercise prevention."),
            ...
            RuleCoverageEntry(id="opportunity-attacks", name="Opportunity Attacks", status=U, notes="Reaction-triggered melee attacks are not implemented."),
            ...
            RuleCoverageEntry(id="arena-geometry", name="Arena geometry", status=A, notes="Current combat uses one-dimensional distance in an open arena."),
        ]
