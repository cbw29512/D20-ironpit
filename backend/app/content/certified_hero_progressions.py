...
from app.content.rogue_final_progression_profile import build_mara_quickstep_level17_profile, build_mara_quickstep_level18_profile, build_mara_quickstep_level19_profile
...
CERTIFIED_HERO_PROGRESSIONS: tuple[CertifiedHeroProgression, ...] = (
    ...
    CertifiedHeroProgression(
        ...
        profile_builders=(
            ...
            build_mara_quickstep_level17_profile,
        ),
    ),
    CertifiedHeroProgression(
