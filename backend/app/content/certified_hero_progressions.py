...
from app.content.rogue_final_progression_profile import build_mara_quickstep_level17_profile, build_mara_quickstep_level18_profile, build_mara_quickstep_level19_profile, build_mara_quickstep_level20_profile, build_mara_quickstep_level18_profile
...
CERTIFIED_HERO_PROGRESSIONS: tuple[CertifiedHeroProgression, ...] = (
    ...
    CertifiedHeroProgression(
        ...
        profile_level_builder=build_kael_stillwater_2014_profile, max_level=19,
    ),
    CertifiedHeroProgression(
