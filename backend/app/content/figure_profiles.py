...
from app.content.figure_profiles_aquatic import AQUATIC_FIGURE_PROFILES
...
MONSTER_FIGURE_PROFILES: dict[str, FigureProfile] = {
    ...
    "Bat": _p("bat", "bat"),
    "Berserker": _p("humanoid", "berserker"),
    "Black Bear": _p("bear", "bear"),
    "Blink Dog": _p("quadruped", "blink-dog"),
    "Blood Hawk": _p("bird", "blood-hawk"),
    "Boar": _p("quadruped", "tusks"),
    "Bone Devil": _p("brute", "bone-devil"),
    "Brown Bear": _p("bear", "bear"),
    "Bugbear Stalker": _p("humanoid", "bugbear-stalker"),
...
MONSTER_FIGURE_PROFILES.update(AQUATIC_FIGURE_PROFILES)
