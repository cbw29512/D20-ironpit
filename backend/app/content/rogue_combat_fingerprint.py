...
def _build_mara_quickstep_combat_profile(level: int) -> PregenCombatProfile:
    try:
        ...
        return PregenCombatProfile(
            ...
            resources=(("adrenaline-rush", proficiency_bonus), ("relentless-endurance", 1), *((("stroke-of-luck", 1),) if level >= 20 else ())),
...
def build_mara_quickstep_level20_combat_profile() -> PregenCombatProfile:
    return _build_mara_quickstep_combat_profile(20)


def build_mara_quickstep_combat_profiles(max_level: int = 20) -> list[PregenCombatProfile]:
