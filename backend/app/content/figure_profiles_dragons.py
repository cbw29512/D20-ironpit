...
DRAGON_FIGURE_PROFILES: dict[str, FigureProfile] = {
    ...
    "Brass Dragon Wyrmling": figure_profile("reptile", "brass-dragon-wyrmling"),
    ...
    "Silver Dragon Wyrmling": figure_profile("reptile", "silver-dragon-wyrmling"),
    ...
    "Young Brass Dragon": figure_profile("reptile", "young-brass-dragon"),
    ...
    "Young Silver Dragon": figure_profile("reptile", "young-silver-dragon"),
