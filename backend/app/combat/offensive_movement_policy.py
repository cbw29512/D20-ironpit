        ...
        for target in living_opponents(attacker, setup):
            ...
            for profile in profiles:
                ...
                if distance <= profile.max_range_ft:
                    # The option is already legal. If movement cannot improve it,
                    # preserve that higher-priority offense instead of walking
                    # toward a lower-priority family and changing the intended turn.
                    candidates.append((
                        profile.priority,
                        0,
                        distance,
