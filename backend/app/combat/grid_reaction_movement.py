    ...
    *,
    ...
    try:
        ...
        for destination in plan.path:
            if _approaches_fear_source(mover, destination, setup):
                break
            ...
            for reactor in reactors:
                if reactor.state.position is None:
                    continue
                before = _distance_to_position(reactor, mover, before_position)
                after = _distance_to_position(reactor, mover, destination)
