...
class OffensiveRangeProfile:
    """Immutable movement-facing contract for one offensive option.
    ...
    priority has been considered. ``expected_value`` only breaks ties inside
    those stronger contracts; it never overrides Recharge or resolver order.
    """
    ...
    def __post_init__(self) -> None:
        ...
        if self.expected_value < 0:
            raise ValueError("Offensive expected value cannot be negative.")
