...
def _apply_condition(
    ...
    condition = apply_timed_condition(
        ...
        repeat_save_failure_continues=effect.repeat_save_failure_continues,
        repeat_save_failure_duration_rounds=effect.repeat_save_failure_duration_rounds,
        repeat_save_failure_ends_on_damage=effect.repeat_save_failure_ends_on_damage,
        repeat_save_failure_allowed_removal_action_ids=effect.repeat_save_failure_allowed_removal_action_ids,
