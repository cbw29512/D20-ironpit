...
def resolve_attack(
    ...
    try:
        ...
        hit, miss_override_feature_id, miss_override_source_name = apply_miss_to_hit_override(attacker, hit=hit)
        ...
        if miss_override_feature_id is not None:
            description += f" {miss_override_source_name or miss_override_feature_id} turns the miss into a hit."
