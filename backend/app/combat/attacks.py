...
def resolve_attack(
    ...
    try:
        ...
        hit, miss_to_hit_applied = resolve_miss_to_hit(attacker, hit, active_turn_key)
        ...
        if miss_to_hit_applied: description += " A miss-to-hit feature converts the miss into a hit."
