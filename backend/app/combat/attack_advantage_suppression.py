...
def apply_defender_advantage_suppression(
    ...
    """Suppress attack-roll Advantage sources when declarative defender data forbids Advantage."""
    try:
        feature = defender.template.progression_features
        if feature.suppress_attack_advantage_while_not_incapacitated and not is_incapacitated(defender):
            return 0
