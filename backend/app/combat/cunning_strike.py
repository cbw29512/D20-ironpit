...
def select_obscure_die_cost(
    ...
    """Select the supported Obscure rider only when the shared Blinded mechanic can affect the target."""
...
def select_canonical_die_cost(
    ...
    """Choose one deterministic supported Sneak Attack trade option for arena automation."""
...
def resolve_obscure(
    ...
    """Resolve the configured Obscure rider through shared save and timed-condition mechanics."""
