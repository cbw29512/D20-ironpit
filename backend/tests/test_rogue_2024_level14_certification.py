...
def test_2024_rogue_level14_inherits_level13_and_adds_only_devious_delta() -> None:
...
def test_obscure_reuses_shared_save_and_universal_blinded_condition() -> None:
    ...
    # Fighter 14 can use Indomitable after the failed save; both fixed rolls fail.
...
def test_2024_rogue_level14_profile_fingerprint_and_registry_match() -> None:
    ...
    assert "shared universal mechanics" in (audits["devious-strikes"].notes or "")
