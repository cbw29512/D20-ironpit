...
def test_devious_strike_obscure_reuses_shared_save_and_blinded_condition() -> None:
    ...
    # Fighter 14 can reroll the failed Dexterity save through Indomitable; both rolls fail.
