...
def test_spy_source_attacks_and_cunning_action_match_srd() -> None:
    ...
    attacks = {
        ...
        for attack in [spy.weapon_attack, *spy.alternate_weapon_attacks]
    }
    ...
    assert (
        shortsword.attack_bonus,
        shortsword.weapon.dice_count,
        shortsword.weapon.dice_size,
        shortsword.damage_bonus,
    ) == (4, 1, 6, 2)
    assert (
        hand_crossbow.attack_bonus,
        hand_crossbow.weapon.dice_count,
        hand_crossbow.weapon.dice_size,
        hand_crossbow.damage_bonus,
    ) == (4, 1, 6, 2)
