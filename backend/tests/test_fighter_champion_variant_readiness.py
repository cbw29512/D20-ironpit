...
def test_level_fifteen_is_supported_and_survivor_is_next_explicit_champion_blocker() -> None:
    ...
    assert audit_fighter_champion_variant_readiness("great-weapon", 16, STATUSES) == []
