...
def test_level_seventeen_thiefs_reflexes_is_declarative_and_scales_sneak_attack() -> None:
    ...
    assert "no Surprise state/path" in (reflexes.notes or "")
...
def test_generic_first_round_scheduler_applies_declarative_extra_turn() -> None:
...
def test_level_eighteen_elusive_uses_generic_advantage_suppression() -> None:
...
def test_level_twenty_stroke_of_luck_uses_generic_miss_override_and_source_name() -> None:
