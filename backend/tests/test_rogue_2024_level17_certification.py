...
def test_2024_rogue_level17_inherits_level16_and_adds_thiefs_reflexes() -> None:
    ...
    assert template.skill_bonuses == {"athletics": 7, "acrobatics": 11}
    ...
    assert "Rogue 17" in template.source


def test_thiefs_reflexes_adds_only_a_round_one_initiative_slot() -> None:
