...
def test_arena_fingerprints_stay_2024_while_all_edition_registry_adds_2014() -> None:
    ...
    completed_ids_2014 = fighter_ids | barbarian_ids | rogue_ids | monk_ids | paladin_ids | cleric_ids
    all_edition_entries = build_all_certified_hero_entries()
    ids_2014 = {
        template.id
        for _, template in all_edition_entries
