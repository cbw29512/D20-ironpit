...
def test_barbarian_seven_candidate_has_deterministic_raw_progression_and_public_promotion() -> None:
...
def test_feral_instinct_reuses_shared_initiative_advantage_engine_with_pounce_supported() -> None:
