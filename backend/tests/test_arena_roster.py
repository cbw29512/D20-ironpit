...
def test_arena_roster_exposes_canonical_template_batch() -> None:
    ...
    assert [item.id for item in roster.monsters] == [
        ...
        "srd-giant-badger", "srd-jackal", "srd-boar", "srd-elk", "srd-giant-boar",
        "srd-minotaur-skeleton", "srd-triceratops", "srd-warhorse-skeleton", "srd-allosaurus", "srd-hippogriff",
        ...
        "srd-tough", "srd-venomous-snake", "srd-violet-fungus", "srd-zombie",
