...
def test_anatomically_distinct_monsters_do_not_share_humanoid_fallbacks() -> None:
    expected = {
        ...
        "Giant Elk": "hoofed", "Giant Wolf Spider": "spider", "Goat": "hoofed",
        ...
        "Tyrannosaurus Rex": "theropod", "Worg": "quadruped", "Xorn": "brute",
    }
    profiles = _profiles()
...
def test_new_batch_has_specific_reviewed_details() -> None:
    expected = {
        ...
        "Spy": "spy", "Swarm of Bats": "bats", "Swarm of Crawling Claws": "crawling-claws",
        "Swarm of Insects": "insects", "Swarm of Rats": "rats", "Swarm of Venomous Snakes": "venomous-snakes",
        "Tough Boss": "tough-boss", "Triceratops": "triceratops", "Violet Fungus": "violet-fungus",
        "Worg": "canine", "Xorn": "xorn",
    }
    profiles = _profiles()
