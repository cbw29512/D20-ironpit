...
- Movement modes never become roster-eligibility filters. The magical Pit remains hospitable to aquatic, flying, burrowing, climbing, unusual-biology, breathing, and atmosphere requirements. Every combatant may use its printed movement modes as though the Pit were a valid native environment for those modes. Environmental hospitality removes habitat-only penalties; it does not grant extra Speed, a movement mode the source does not have, or free movement.
