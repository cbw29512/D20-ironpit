...
- There is no user-selected starting distance. Dedicated melee/frontline combatants begin already engaged with the opposing frontline at 5 feet. Dedicated ranged combatants and supported casters begin one rank behind their own frontline. Encounter input rejects legacy starting-distance fields instead of silently accepting them.
