...
| Spellcasting | 1 | ENGINE_EXISTS_BINDING_MISSING | Deterministic 2014 Bard spell-known package is defined and routed through canonical spell policy; runtime bindings reuse existing spell attack/save/healing/buff/control primitives. |
...
| Countercharm | 6 | ENGINE_TRULY_MISSING | Reuse contextual save-Advantage semantics/tags. The missing remainder is a source-owned timed friendly save aura: Action activation, 30-foot live radius, hearing eligibility, frightened/charmed save tags, end-of-next-turn expiry, and early termination if the source is incapacitated or silenced. Do not snapshot recipients at activation because movement or Deafened can change eligibility before a save. |
| Magical Secrets | 10/14/18 | ENGINE_EXISTS_BINDING_MISSING | Deterministic legal selections are defined inside the 2014 Bard spells-known package and reuse already-certified Cleric/Paladin primitives. |
...
| Additional Magical Secrets | 6 | ENGINE_EXISTS_BINDING_MISSING | Deterministic bonus-known Bless + Spiritual Weapon selections are defined; they reuse existing modifier/concentration and persistent-spell-attack primitives and do not count against Bard Spells Known. |
